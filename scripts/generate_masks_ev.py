...
"""
Not working on windowsdue to ImageJ not working as expected/ refer to notebooks/labeling_script.ipynb for generating masks
works on linux
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="Brightfield",
        help="The folder to consider.",
    )
    parser.add_argument(
        "--seg_args",
        type=dict,
        default={"ch1i": True, "ch1a": 5, "ch1s": 15},
    ...
    Utils.generate_np_masks(
        tif_tuples, seg_args=args.seg_args, seg_method=args.seg_method
    )
